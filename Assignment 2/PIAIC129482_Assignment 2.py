...
def function13():
    ...
    ans = a[(a>5)*(a<10)] #write your code here 
...
def function17():
    ...
    return np.where(((arr%3==0)& (arr%5==0))==True,"Yes","No")          # Write Your Code HERE
...
def function18():
    ...
    x = x = np.intersect1d(b,a) 
    np.count_nonzero(x >= 1)# Write you code Here
    return x
...
def fucntion20():
    ...
    return np.vectorize(xyz)(x) #Write your Code here
